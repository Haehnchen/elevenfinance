        ...
        const requests = [
          (callbackInner) => {
            fetchAllowance({
              ...
              .catch(error => callbackInner(error, 0))
          },
